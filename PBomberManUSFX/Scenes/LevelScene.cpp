    ...
    : Scene(_gameManager), score(prevScore), stage(_stage)
{
    ...
    switch (factoryGameType)
    {
    case 1: factory = new FactoryGameCartoon(); break;
    case 2:factory = new FactoryGameClasico(); break;
    case 3:factory = new FactoryGamePersonalizado(); break;
    case 4:factory = new FactoryGameRealista();  break;
    default: ; break;
